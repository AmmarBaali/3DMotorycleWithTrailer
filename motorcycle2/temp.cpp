...
enum {TORUS_MATERIAL = 1, TEAPOT_MATERIAL = 2, ICO_MATERIAL = 3} MaterialDisplayList;
...
GLfloat emerald_diffuse[] = {0.07568, 0.61424, 0.07568};
GLfloat emerald_specular[] = {0.633, 0.727811, 0.633};
...
void display(void)
{
	...
	output(850, 100, "Shade model: %s",	shade_model == GL_SMOOTH ? "smooth" : "flat");
	glPopMatrix();
	glMatrixMode(GL_PROJECTION);
	glPopMatrix();
	glPopAttrib();
